...
const copy = {
  en: {
    ...
    profileIntroStart: "A Yonex S-tier stringer who has served over 10,000 customers, including ",
    profileIntroNames: "Lin Dan, Viktor Axelsen, Harvey Jiang, and Kento Momota",
    profileIntroEnd:
      ". He was borned in Hunan and raised in Shenzhen, now he is under the guidance of Liu Xin.",
  ...
  zh: {
    ...
    profileIntroEnd: "穿线，服务超10000+客户，广受好评。生于湖南，长于深圳，目前师从刘鑫。",
...
function StringIdentity({ item, language }: { item: StringItem; language: Language }) {
  ...
  return (
    <span className="string-identity">
      ...
      <span>{displayModelName(item, language)}</span>
    </span>
  );
}
